    ...
    <section className="relative bg-transparent w-full" id="about">
      <div className="relative z-10 min-h-screen flex flex-col justify-center text-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <FlipWords
              words={t('hero.taglineWords', { returnObjects: true }) as string[]}
              duration={3000}
          ...
          >
            ...
            <motion.a
              ...
              className="p-4 border border-white/20 rounded-full hover:border-white/40 transition-all duration-300 hover:bg-white/5"
            >
              <Github size={24} className="text-gray-300 hover:text-white transition-colors duration-300" />
            </motion.a>
            ...
            <motion.a
              ...
              className="p-4 border border-white/20 rounded-full hover:border-white/40 transition-all duration-300 hover:bg-white/5"
            >
              <Mail size={24} className="text-gray-300 hover:text-white transition-colors duration-300" />
            </motion.a>
          </motion.div>
