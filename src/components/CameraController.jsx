...
const getOrbitCenters = (astronautRotation, astronautPosition) => {
  ...
  return {
    MAIN: { 
      ...
      orbitHeight: 1.8, // Câmera elevada para ângulo de ~20 graus
      fov: 75,
      background: null,
...
export const CameraController = ({ 
  ...
  const currentHeight = useRef(1.8); // Altura inicial elevada para ~20 graus
  const targetHeight = useRef(1.8); // Altura inicial elevada para ~20 graus
  ...
  const startHeight = useRef(1.8); // Altura inicial elevada para ~20 graus
